...
<header>
    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="#">AlterArticle</a>
...
<main role="main" class="container">
    ...
    <form method="post" action="/modifyAction">
        <h2 class="mt-5" align="center">标题：<input type="text" name="title" value="${modify.title}"></h2>
        <br>
        <h5>正文：</h5>
        <textarea  class="form-control" rows="15" style="resize:none" name="content">${modify.content}</textarea>
        <br />
